...
if (isset($_GET['consulta_2_start']) && isset($_GET['consulta_2_end'])) {
  $consulta2 = $mysqli->query(
    "select * from pagamentos where data between '" . $_GET['consulta_2_start'] . "' and '" . $_GET['consulta_2_end'] . "'"
  );
          ...
          <div class="align-items-strech">
            <nav>
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a class="nav-link " href="index.php">Consulta 7</a>
                <a class="nav-link active">Consulta 7</a>
              </div>
            </nav>
                                ...
                                foreach ($consulta2 as $item) {
                                  echo ' 
                                    <tr>
                                      ...
                                      <td class="border-bottom-0">
                                        <h6 class="fw-semibold mb-1">' . $item['apelidos'] . '</h6> 
                                      </td>
                                      <td class="border-bottom-0">
                                        <p class="mb-0 fw-normal">' . $item['data'] . '</p>
                                      </td>
                                      <td class="border-bottom-0">
                                        <p class="mb-0 fw-normal">' . $item['quantia'] . ' AOA</p>
                                      </td>
                                    </tr>
                                  ';
                                }
