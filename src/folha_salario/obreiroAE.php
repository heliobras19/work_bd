<?php
   ...
   $result = $mysqli->query(
     ...
     time(  turno.horario ) as horario , 
                 ...
                 obreiro.cod_area = area.cod_area where cod_obreiro ='. $id.';'
   );
   ...
   if (isset($_POST['cadastrar'])) {
     ...
     $sql = "UPDATE obreiro SET nome = '$nome', apelidos = '$apelidos', data_nasc = '$data_nasc', 
     cod_area = '$cod_area', cod_turno = '$cod_turno' where cod_obreiro = '$id'";
   
     if ($mysqli->query($sql) === TRUE) {
       echo "<script>alert('Dados do obreiro atualizados com sucesso!');</script>";
                  ...
                  <div class="align-items-strech">
                     <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                           <button class="nav-link active" id="nav-list-tab" data-bs-toggle="tab" data-bs-target="#nav-list" type="button" role="tab" aria-controls="nav-list" aria-selected="true">Edição</button>
                           <a class="nav-link " href="obreiro.php"  data-bs-target="#nav-new" type="button" role="tab" aria-controls="nav-new" aria-selected="false">Listagem</a>
                        </div>
                     </nav>
                     <div class="tab-pane fade show active" id="nav-list" role="tabpanel" aria-labelledby="nav-list-tab" tabindex="0">
                        <div class="card">
                           <div class="card-body">
                              <h5 class="card-title fw-semibold mb-4">Editar Obreiro</h5>
                              <div class="card">
                                 <div class="card-body">
                                    <form action="" method="post">
                                       ...
                                       <div class="mb-3">
                                          ...
                                          value = "<?php echo $obreiroItem['nome'] ?>" >
                                       </div>
                                       <div class="mb-3">
                                          <label for="apelidos" class="form-label">Apelidos:</label>
                                          <input type="text" name="apelidos" class="form-control" id="apelidos" 
                                          aria-describedby="apelidosHelp" value = "<?php echo $obreiroItem['apelidos'] ?>" >
                                       </div>
                                       <div class="mb-3">
                                          <label for="dt_nasc" class="form-label">Data de Nascimento:</label>
                                          <input type="date" name="data_nasc" class="form-control" id="dt_nasc" 
                                          aria-describedby="dt_nascHelp" value = "<?php echo $obreiroItem['data_nasc'] ?>" >
                                       </div>
                                       <?php 
