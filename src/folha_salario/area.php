...
$result = $mysqli->query("SELECT area.*,centro_custo.nome AS centro  FROM area JOIN centro_custo ON centro_custo.cod_centro = area.cod_centro;");
          ...
          <div class="align-items-strech">
            ...
            <div class="tab-content" id="nav-tabContent">
              ...
              <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab" tabindex="0">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">Lista de Áreas</h5>
                            ...
                            <table class="table text-nowrap mb-0 align-middle">
                              <thead class="text-dark fs-4">
                                <tr>
                                  ...
                                  <th class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0">CENTRO</h6>
                                  </th>
                              ...
                              <tbody>
                                ...
                                foreach ($data as $item) {
                                  echo ' 
                                      ...
                                      <td class="border-bottom-0">
                                        <p class="mb-0 fw-normal">' . $item['centro'] . '</p>
                                      </td>
                                      <td class="border-bottom-0">
