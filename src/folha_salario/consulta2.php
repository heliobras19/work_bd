...
/*
    array (size=4)
      'nome' => string 'Kuenda' (length=6)
      'apelidos' => string 'João Mayeye' (length=12)
      'data_presenca' => string '2023-06-13' (length=10)
      'qtd_minutos' => string '15' (length=2)
  1 => 
    array (size=4)
      'nome' => string 'Rui' (length=3)
      'apelidos' => string ' Yuri Malemba' (length=13)
      'data_presenca' => string '2023-06-13' (length=10)
      'qtd_minutos' => string '40' (length=2)
*/
?>
                    ...
                    <form method="GET" action="">
                      <div class="row">
                        <div class="mb-3 col">
                          ...
                          <input name="consulta_2_start" type="date" class="form-control" id="dt_nasc" aria-describedby="dt_nascHelp">
                        </div>
                        <div class="mb-3 col">
                          <label for="dt_nasc" class="form-label">Data de Fim:</label>
                          <input name="consulta_2_end" type="date" class="form-control" id="dt_nasc" aria-describedby="dt_nascHelp">
                        </div>
                        <div class="mb-3 col">
