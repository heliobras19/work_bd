...
$result = $mysqli->query(
  'SELECT assiduidade.*, obreiro.nome, obreiro.apelidos  FROM assiduidade join obreiro on obreiro.cod_obreiro = assiduidade.cod_obreiro;'
);
          ...
          <div class="align-items-strech">
            ...
            <div class="tab-content" id="nav-tabContent">
              ...
              <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab" tabindex="0">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">Lista de Presenças</h5>
                            ...
                            <table class="table text-nowrap mb-0 align-middle">
                              <thead class="text-dark fs-4">
                                <tr>
                                  ...
                                  <th class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0">Data Presença</h6>
                                  </th>
                                  <th class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0">Entrada</h6>
                                  </th>
                                  <th class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0">Saída</h6>
                                  </th>
                                  <th class="border-bottom-0">
                                ...
                                foreach ($data as $item) {
                                  ...
                                  <tr>
                                    <td class="border-bottom-0">
                                      <h6 class="fw-semibold mb-0">' . $item['cod_assiduidade'] . '</h6>
                                    </td>
                                    <td class="border-bottom-0">
                                      <h6 class="fw-semibold mb-1">' . $item['data_presenca'] . '</h6> 
                                    </td>
                                    <td class="border-bottom-0">
                                      <p class="mb-0 fw-normal">' . $item['entrada'] . '</p>
                                    </td>
                                    <td class="border-bottom-0">
                                      <p class="mb-0 fw-normal">' . $item['saida'] . '</p>
                                    </td>
                                    <td class="border-bottom-0">
